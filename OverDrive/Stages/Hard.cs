...
namespace OverDrive.Stages
{
    class Hard : Stage
    {
        ...
        public override void Init()
        {
            ...
            background.TexturePath = "Backgrounds\\Stage3";
            ...
            rivalCar.CopyCat(garage.Get("Rival_Hard"));
            rivalCar.AiType = 1;
            entities.Add(rivalCar);

            npcManager.MaxCount = 12;
            npcManager.Interval = 18.0f;
            itemManager.Interval = 90.0f;
