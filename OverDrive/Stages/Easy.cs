...
namespace OverDrive.Stages
{
    class Easy : Stage
    {
        ...
        public override void Init()
        {
            ...
            background.TexturePath = "Backgrounds\\Stage1";
            ...
            rivalCar.CopyCat(garage.Get("Rival_Easy"));
            rivalCar.AiType = 0;
